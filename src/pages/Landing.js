...
const smartcampus = [
  {
    ...
    descripcion: "Plataforma web de la calidad del aire en interiores y exteriores de la UNI.",
    link: "/calidad-del-aire",
    imagen: "https://images.pexels.com/photos/1528361/pexels-photo-1528361.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
  },
  {
    titulo: "Comedor Universitario",
    descripcion: "Página web del menú, balance nutricional y para sacar turno.",
    link: "/#",
    imagen: "https://1.bp.blogspot.com/-LJ1jyLSwlnU/XfPW8rk0U2I/AAAAAAAAPGc/s87z5i3bvIMnSu1ocH1N4jUdwg8-9ML_wCNcBGAsYHQ/s1600/IMG_9696.CR2",
  },
  {
      ...
      <div className="container__landing">
        ...
        <div class="contenedor">
          {smartcampus.map((sc, index) => {
            return (
              <a href={sc.link} target={index===0 ? `_blank`:'_self'} rel="noopener noreferrer">
                <figure>
                  <img
                    src={sc.imagen}
                    alt="imagen-ca"
