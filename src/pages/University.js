    ...
    return(<div>
        ...
        <div className="container-university-main">
            <div className='container-logo-map'>
                ...
                <iframe src="http://192.168.52.232:3000/d-solo/7bhq8tc4z/universidad-nacional-de-ingenieria?orgId=1&panelId=14" width="100%" height="100%" frameborder="0" title='mapa-uni'></iframe>
            </div>
