        ...
        <div>
            <div className='nav-calidad-aire'>
                <div className='nav-superior'>
                    ...
                    <div className='container-tematica'>Calidad de Aire - PUERTA 5</div>
                </div>
                <ul>
            ...
            <div className="container-concentracion-de-gases item" id='concentracion'>
                    ...
                    <div className='container-gauges-ca-ctic'>
                        ...
                        <div className='container-2-gauges'>
                            <div>
                                ...
                                <iframe src="http://192.168.52.232:3000/d-solo/6NlOZeDVk/calidad-de-aire-puerta-5?orgId=1&panelId=48" width="100%" height="100%" frameborder="0"></iframe>
                            </div>
                            <div>
                                ...
                                <iframe src="http://192.168.52.232:3000/d-solo/6NlOZeDVk/calidad-de-aire-puerta-5?orgId=1&panelId=46" width="100%" height="100%" frameborder="0"></iframe>
                            </div>
                        </div>
                        <div className='container-2-gauges'>
                            <div>
                                ...
                                <iframe src="http://192.168.52.232:3000/d-solo/6NlOZeDVk/calidad-de-aire-puerta-5?orgId=1&panelId=18" width="100%" height="100%" frameborder="0"></iframe>
                            </div>
                            <div>
                                ...
                                <iframe src="http://192.168.52.232:3000/d-solo/6NlOZeDVk/calidad-de-aire-puerta-5?orgId=1&panelId=44" width="100%" height="100%" frameborder="0"></iframe>
                            </div>
                        </div>
                        <div className='container-2-gauges'>
                            <div>
                                ...
                                <iframe src="http://192.168.52.232:3000/d-solo/6NlOZeDVk/calidad-de-aire-puerta-5?orgId=1&panelId=16" width="100%" height="100%" frameborder="0"></iframe>
                            </div>
                            <div>
                                ...
                                <iframe src="http://192.168.52.232:3000/d-solo/6NlOZeDVk/calidad-de-aire-puerta-5?orgId=1&panelId=32" width="100%" height="100%" frameborder="0"></iframe>
                            </div>
                        </div>
                    </div>
                ...
                <div className='container-historico'>
                    <iframe src="http://192.168.52.232:3000/d-solo/6NlOZeDVk/calidad-de-aire-puerta-5?orgId=1&panelId=22" width="100%" height="100%" frameborder="0"></iframe>
                </div>
            </div>
